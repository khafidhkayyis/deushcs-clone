                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                <label htmlFor="companySize" className="block text-sm font-medium text-gray-700 mb-2 ">
                                    {t('consultation.form.companySize')}
                                </label>
                                <select
                                    id="companySize"
                                    name="companySize"
                                    ...
                                    className="bg-white w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#122430] focus:border-transparent"
                                >
                                    <option value="1 - 100">{t('consultation.form.companySizeOptions.small')}</option>
                                    <option value="101 - 500">{t('consultation.form.companySizeOptions.medium')}</option>
                                    <option value="501 - 1000">{t('consultation.form.companySizeOptions.large')}</option>
                                    <option value="1000+">{t('consultation.form.companySizeOptions.enterprise')}</option>
                                </select>
                            </div>
                            ...
                            <div>
                                <label htmlFor="countryCity" className="block text-sm font-medium text-gray-700 mb-2">
                                    {t('consultation.form.countryCity')}
                                </label>
                                <input
                                    type="text"
                                    id="countryCity"
                            ...
                            <div>
                                <label htmlFor="hearAboutUs" className="block text-sm font-medium text-gray-700 mb-2">
                                    {t('consultation.form.hearAboutUs')}
                                </label>
                                <select
                                    id="hearAboutUs"
                                    name="hearAboutUs"
                                    ...
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#122430] focus:border-transparent bg-white"
                                >
                                    <option value="Google Search">{t('consultation.form.hearAboutUsOptions.google')}</option>
                                    <option value="Social Media">{t('consultation.form.hearAboutUsOptions.social')}</option>
                                    <option value="Referral">{t('consultation.form.hearAboutUsOptions.referral')}</option>
                                    <option value="Advertisement">{t('consultation.form.hearAboutUsOptions.advertisement')}</option>
                                    <option value="Other">{t('consultation.form.hearAboutUsOptions.other')}</option>
                                </select>
                            </div>
                            ...
                            <div>
                                <label htmlFor="phoneNumber" className="block text-sm font-medium text-gray-700 mb-2">
                                    {t('consultation.form.phoneNumber')}
                                </label>
                                <input
                                    type="tel"
                                    id="phoneNumber"
                    ...
                    <div className="flex flex-col items-center order-1 lg:order-2">
                        ...
                        <div className="space-y-4 text-[#122430]">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <a href={`https://wa.me/${t('consultation.contact.whatsapp').replace(/[^0-9]/g, '')}`} className="text-base md:text-lg hover:underline">
                                    {t('consultation.contact.whatsapp')}
                                </a>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <a href={`mailto:${t('consultation.contact.email')}`} className="text-base md:text-lg hover:underline">
                                    {t('consultation.contact.email')}
                                </a>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <p className="text-base md:text-lg">
                                    {t('consultation.contact.address')}
                                </p>
                            </div>
                        </div>
                    </div>
